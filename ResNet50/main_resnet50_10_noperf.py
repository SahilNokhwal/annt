...
def fit_one_cycle(epochs, max_lr, model, train_loader, test_loader,
    ...
    for epoch in range(epochs):
        ...
        logger(str('train_loss:'+str(result['train_loss'])+ ' || val_loss:'+str(result['val_loss'])+" || val_acc:"+str(result['val_acc'])), "cifar10_no_perf_training.log")
...
save_graph_loss('CIFAR10_no_perf_loss_plot.png', his_train_loss, his_val_loss)
